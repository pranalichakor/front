...
const ResetOTP = () => {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gradient-to-br from-[#1a0139] via-[#300560] to-[#3c0389]">
      <div className="backdrop-md bg-white/10 shadow-lg border border-white/20 rounded-xl px-8 py-10 w-[22rem] md:w-96 text-white transition-all duration-200 transform hover:scale-105 hover:shadow-2xl hover:shadow-purple-300/20">
